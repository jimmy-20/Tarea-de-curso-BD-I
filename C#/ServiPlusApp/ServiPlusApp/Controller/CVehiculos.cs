...
namespace ServiPlusApp.Controller
{
    public class CVehiculos : IAcciones 
    {
        ...
        {
            if (Fabrica.SiFilaSeleccionada(FrmVehiculo.DgvTablas) is false)
            {
                return;
            }
        ...
        private void Seleccionar_IdCliente(object sender, EventArgs e)
        {
        ...
        public void Editar()
        {
            ...
            DataGridViewRow v = FrmVehiculo.DgvTablas.SelectedRows[0];
